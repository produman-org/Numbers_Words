...
class Numbers_Words_Locale_ru extends Numbers_Words
{
     ...
     * @access public
     */
    public string $lang_native = 'Русский';
     ...
     * @access private
     */
    private string $_minus = 'минус'; // minus sign
     ...
     */
    public string $def_currency = 'RUB'; // Russian rouble
